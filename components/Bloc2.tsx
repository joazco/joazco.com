...
const Bloc2 = () => {
  return (
    ...
    <div className="joazco--block-2-header"><h2>Qui sommes-nous?</h2></div>
    <div>
      <p>
        ...
        web et d’applications mobiles.<br />
    ...
    <div className="joazco--block-2-content" data-aos="zoom-in">
      <div>
        ...
        <p>
          Expert dans les domaines du front end, du back end, de
          l’hébergement de sites web et du serverless, Joazco vous
          accompagne tout au long de votre projet de création de site
          web.<br />
          Bénéficiez des technologies web les plus adaptées à votre marché,
          à votre demande. Quels que soient vos projets web, Joazco les
          concrétisent.
        </p>
      </div>
      ...
      <div className="joazco--block-2-content-2" data-aos="zoom-in">
        ...
        <p>
          Donnez vie à vos projets mobile avec notre expertise.<br />
